...
import marc.henrard.murisq.model.rationalmulticurve.RationalTwoFactor2HWShapePlusCstTemplate;
 ...
 */
@Test
public class RationalTwoFactor2HWShapePlusCstTemplateTest {
  ...
  public void of() {
    RationalTwoFactor2HWShapePlusCstTemplate test = RationalTwoFactor2HWShapePlusCstTemplate
  ...
  public void generate() {
    ...
    RationalTwoFactor2HWShapePlusCstParameters modelComputed = test.generate(parameters);
    RationalTwoFactor2HWShapePlusCstParameters modelExpected =
        RationalTwoFactor2HWShapePlusCstParameters.of(
  ...
  public void incorrectInput() {
    ...
    fixed.set(11);
    assertThrowsIllegalArg(() -> RationalTwoFactor2HWShapePlusCstTemplate
        .of(TIME_MEASURE, DF, VAL_DATE_TIME.toLocalTime(), VAL_DATE_TIME.getZone(), GUESS, fixed));
