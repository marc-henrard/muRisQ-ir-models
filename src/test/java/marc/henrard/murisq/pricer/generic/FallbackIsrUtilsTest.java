...
/**
 * Tests {@link FallbackIsrUtils}.
 * 
 * @author Marc Henrard
 */
public class FallbackIsrUtilsTest {
  ...
  public void fallback_isr_usd() {
    ...
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateLiborComputed = FallbackIsrUtils.fallbackMechanismUsd(rateOis[looptest]);
  ...
  public void fallbackequivalent_isr_usd() {
    ...
    int nbTests = rateOis.length;
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateLibor = FallbackIsrUtils.fallbackMechanismUsd(rateOis[looptest]);
      double rateOisComputed = FallbackIsrUtils.fallbackEquivalentRateUsd(rateLibor);
  ...
  public void fallback_isr_usd_AD() {
    ...
    int nbTests = rateOis.length;
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateIrs = FallbackIsrUtils.fallbackMechanismUsd(rateOis[looptest]);
      ValueDerivatives rateIrsUp = FallbackIsrUtils.fallbackMechanismUsdAD(rateOis[looptest] + SHIFT_FD);
      ValueDerivatives rateIrsDown = FallbackIsrUtils.fallbackMechanismUsdAD(rateOis[looptest] - SHIFT_FD);
      ValueDerivatives rateIrsAd = FallbackIsrUtils.fallbackMechanismUsdAD(rateOis[looptest]);
  ...
  public void fallback_isr_gbp_1Y() {
    ...
    int nbTests = rateOis.length;
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateIrsComputed = FallbackIsrUtils.fallbackMechanismGbp1Y(rateOis[looptest]);
  ...
  public void fallbackequivalent_isr_gbp_1Y() {
    ...
    int nbTests = rateOis.length;
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateIrs = FallbackIsrUtils.fallbackMechanismGbp1Y(rateOis[looptest]);
      double rateOisComputed = FallbackIsrUtils.fallbackEquivalentRateGbp1Y(rateIrs);
      assertThat(rateOisComputed).isEqualTo(rateOis[looptest], TOLERANCE_RATE);
    }
  }
  ...
  public void fallback_isr_gbp_1Y_AD() {
    ...
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateIrs = FallbackIsrUtils.fallbackMechanismGbp1Y(rateOis[looptest]);
      ValueDerivatives rateIrsUp = FallbackIsrUtils.fallbackMechanismGbp1YAD(rateOis[looptest] + SHIFT_FD);
      ValueDerivatives rateIrsDown = FallbackIsrUtils.fallbackMechanismGbp1YAD(rateOis[looptest] - SHIFT_FD);
      ValueDerivatives rateIrsAd = FallbackIsrUtils.fallbackMechanismGbp1YAD(rateOis[looptest]);
      assertThat(rateIrs).isEqualTo(rateIrsAd.getValue(), TOLERANCE_RATE);
      assertThat((rateIrsUp.getValue() - rateIrsDown.getValue()) / (2 * SHIFT_FD))
          .isEqualTo(rateIrsAd.getDerivative(0), TOLERANCE_D1);
      assertThat((rateIrsUp.getDerivative(0) - rateIrsDown.getDerivative(0)) / (2 * SHIFT_FD))
  ...
  public void fallback_isr_gbp_Plus1Y() {
    ...
    int nbTests = rateOis.length;
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateLiborComputed = FallbackIsrUtils.fallbackMechanismGbpPlus1Y(rateOis[looptest]);
  ...
  public void fallbackequivalent_isr_gbp_Plus1Y() {
    ...
    int nbTests = rateOis.length;
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateIrs = FallbackIsrUtils.fallbackMechanismGbpPlus1Y(rateOis[looptest]);
      double rateOisComputed = FallbackIsrUtils.fallbackEquivalentRateGbpPlus1Y(rateIrs);
      assertThat(rateOisComputed).isEqualTo(rateOis[looptest], TOLERANCE_RATE);
    }
  }
  ...
  public void fallback_isr_gbp_Plus1Y_AD() {
    ...
    for (int looptest = 0; looptest < nbTests; looptest++) {
      double rateIrs = FallbackIsrUtils.fallbackMechanismGbpPlus1Y(rateOis[looptest]);
      ValueDerivatives rateIrsUp = FallbackIsrUtils.fallbackMechanismGbpPlus1YAD(rateOis[looptest] + SHIFT_FD);
      ValueDerivatives rateIrsDown = FallbackIsrUtils.fallbackMechanismGbpPlus1YAD(rateOis[looptest] - SHIFT_FD);
      ValueDerivatives rateIrsAd = FallbackIsrUtils.fallbackMechanismGbpPlus1YAD(rateOis[looptest]);
      assertThat(rateIrs).isEqualTo(rateIrsAd.getValue(), TOLERANCE_RATE);
      assertThat((rateIrsUp.getValue() - rateIrsDown.getValue()) / (2 * SHIFT_FD))
          .isEqualTo(rateIrsAd.getDerivative(0), TOLERANCE_D1);
      assertThat((rateIrsUp.getDerivative(0) - rateIrsDown.getDerivative(0)) / (2 * SHIFT_FD))
