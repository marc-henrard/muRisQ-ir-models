...
/**
 * Tests {@link MultiplyFixedCurveDefinition}.
 * 
 * @author Marc Henrard
 */
public class MultiplyFixedCurveDefinitionTest {
  ...
  @Test
  public void builder() {
    MultiplyFixedCurveDefinition test = MultiplyFixedCurveDefinition.builder()
  ...
  public void generate_curve() {
    ...
    assertThat(generatedCurve instanceof MultiplyFixedCurve).isTrue();
  }
