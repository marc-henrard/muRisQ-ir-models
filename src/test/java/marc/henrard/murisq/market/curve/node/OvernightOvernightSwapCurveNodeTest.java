...
public class OvernightOvernightSwapCurveNodeTest {
  ...
  public void metadata_last_fixing() {
    ...
    LocalDate valuationDate = LocalDate.of(2015, 1, 22);
    LocalDate fixingExpected = LocalDate.of(2025, 1, 27);
    DatedParameterMetadata metadata = node.metadata(valuationDate, REF_DATA);
  ...
  public void coverage() {
    ...
    OvernightOvernightSwapCurveNode test2 = OvernightOvernightSwapCurveNode.of(
        OvernightOvernightSwapTemplate.of(TENOR_10Y, OvernightOvernightSwapConventions.EUR_EONIA_3M_ESTER_3M),
