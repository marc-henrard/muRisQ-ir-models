...
class BondFuturesUtilsTest {
  ...
  private static final LegalEntityId ISSUER_ID_DE = LegalEntityId.of("muRisQ-Ticker", "GOVT-DE");
  ...
  private static final StandardId[] BOND_SECURITY_ID_DE = new StandardId[] {
      StandardId.of("muRisQ-Ticker", "DE0001102564"),
      StandardId.of("muRisQ-Ticker", "DE0001102606"),
      StandardId.of("muRisQ-Ticker", "DE0001102580"),
      StandardId.of("muRisQ-Ticker", "DE0001102440"),
      StandardId.of("muRisQ-Ticker", "DE0001102432")};
  ...
  private static final double[] CONVERSION_FACTOR_EXPECTED_DE =
      new double[] {0.59455, 0.685182, 0.594076, 0.751436, 0.565991};

  @Test
  public void cf_eurex() {
    for (int i = 0; i < NB_BOND_DE; ++i) {
      double cfComputed =
          BondFuturesUtils.conversionFactorEurexDE(BOND_DE[i], SETTLE_DATE_DE[i], NOTIONAL_COUPON_DE[i]);
      assertThat(cfComputed).isCloseTo(CONVERSION_FACTOR_EXPECTED_DE[i], offset(TOLERANCE_CF_EUREX));
    }
  }

  /* ICE conversion factor - Gilts */
  private static final LegalEntityId ISSUER_ID_UK = LegalEntityId.of("muRisQ-Ticker", "GOVT-UK");
  ...
  private static final StandardId[] BOND_SECURITY_ID_UK = new StandardId[] {
      StandardId.of("muRisQ-Ticker", "GB00BFWFPL34"),
      StandardId.of("muRisQ-Ticker", "GB00BDRHNP05"),
      StandardId.of("muRisQ-Ticker", "GB00B52WS153"),
      StandardId.of("muRisQ-Ticker", "GB00BMBL1F74")};
  ...
  private static final double[] CONVERSION_FACTOR_EXPECTED_UK =
      new double[] {0.9682306, 0.8845462, 1.0465032, 0.4330701};
  ...
  private static final LegalEntityId ISSUER_ID_US = LegalEntityId.of("muRisQ-Ticker", "GOVT-US");
  ...
  private static final StandardId[] BOND_SECURITY_ID_US = new StandardId[] {
      StandardId.of("muRisQ-Ticker", "T-1.50-2010-10-31"),
      StandardId.of("muRisQ-Ticker", "T-1.125-2012-01-15"),
      StandardId.of("muRisQ-Ticker", "T-2.75-2013-10-31"),
      StandardId.of("muRisQ-Ticker", "T-3.75-2018-11-15"),
      StandardId.of("muRisQ-Ticker", "T-4.50-2038-05-15")};
  ...
  private static final double[] CONVERSION_FACTOR_EXPECTED_US =
      new double[] {0.9229, 0.8747, 0.8653, 0.8357, 0.7943};

  @Test
  public void cf_cme() {
    for (int i = 0; i < 3; ++i) {
      double cfComputed =
          BondFuturesUtils.conversionFactorCmeUsShort(BOND_US[i], SETTLE_DATE_US[i], NOTIONAL_COUPON_US[i]);
      assertThat(cfComputed).isCloseTo(CONVERSION_FACTOR_EXPECTED_US[i], offset(TOLERANCE_CF_CME));
    }
    for (int i = 3; i < NB_BOND_US; ++i) {
      double cfComputed =
          BondFuturesUtils.conversionFactorCmeUsLong(BOND_US[i], SETTLE_DATE_US[i], NOTIONAL_COUPON_US[i]);
      assertThat(cfComputed).isCloseTo(CONVERSION_FACTOR_EXPECTED_US[i], offset(TOLERANCE_CF_CME));
    }
  }
