...
final class LoadedCurveSettings2
   ...
   */
  static LoadedCurveSettings2 of(
      CurveName curveName,
    ...
    return new LoadedCurveSettings2(
  ...
  InterpolatedNodalCurve createCurve(LocalDate date, List<LoadedCurveNode2> curveNodes) {
    // copy and sort
    List<LoadedCurveNode2> nodes = new ArrayList<>(curveNodes);
    ...
    for (int i = 0; i < nodes.size(); i++) {
      LoadedCurveNode2 point = nodes.get(i);
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code LoadedCurveSettings2}.
   */
  private static final TypedMetaBean<LoadedCurveSettings2> META_BEAN =
      LightMetaBean.of(
          LoadedCurveSettings2.class,
   ...
   */
  public static TypedMetaBean<LoadedCurveSettings2> meta() {
    return META_BEAN;
  }
  ...
  @Override
  public TypedMetaBean<LoadedCurveSettings2> metaBean() {
    return META_BEAN;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      LoadedCurveSettings2 other = (LoadedCurveSettings2) obj;
  ...
  public String toString() {
    ...
    buf.append("LoadedCurveSettings2{");
