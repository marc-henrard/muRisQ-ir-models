...
public final class LiborMarketModelDisplacedDiffusionDeterministicSpreadParameters
  ...
  public String toString() {
    ...
    buf.append("overnightIndex").append('=').append(overnightIndex).append(',').append(' ');
    buf.append("iborIndex").append('=').append(iborIndex).append(',').append(' ');
    ...
    buf.append("iborTimes").append('=').append(iborTimes).append(',').append(' ');
    buf.append("accrualFactors").append('=').append(accrualFactors).append(',').append(' ');
    buf.append("multiplicativeSpreads").append('=').append(multiplicativeSpreads).append(',').append(' ');
    buf.append("displacements").append('=').append(displacements).append(',').append(' ');
