...
/**
 * Implementation of {@link OvernightIndexRates} based on an existing index rates taken at a 
 * forward date.
 * 
 * @author Marc Henrard
 */
@BeanDefinition(factoryName = "of")
public final class OvernightIndexRatesImpliedForward
    implements OvernightIndexRates, ImmutableBean, Serializable {

  /** The underlying provider. */
  @PropertyDefinition(validate = "notNull")
  private final OvernightIndexRates underlying;
  ...
  public double periodRate(OvernightIndexObservation startDateObservation, LocalDate endDate) {
    return underlying.periodRate(startDateObservation, endDate);
  }
  ...
  @Override
  public OvernightIndexRates withParameter(int parameterIndex, double newValue) {
    return OvernightIndexRatesImpliedForward
        .of(underlying.withParameter(parameterIndex, newValue), valuationDate, fixings);
  }

  @Override
  public OvernightIndexRates withPerturbation(ParameterPerturbation perturbation) {
    return OvernightIndexRatesImpliedForward
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code OvernightIndexRatesImpliedForward}.
   * @return the meta-bean, not null
   */
  public static OvernightIndexRatesImpliedForward.Meta meta() {
    return OvernightIndexRatesImpliedForward.Meta.INSTANCE;
  }

  static {
    MetaBean.register(OvernightIndexRatesImpliedForward.Meta.INSTANCE);
  }
   ...
   * @return the instance
   */
  public static OvernightIndexRatesImpliedForward of(
      OvernightIndexRates underlying,
      LocalDate valuationDate,
      LocalDateDoubleTimeSeries fixings) {
    return new OvernightIndexRatesImpliedForward(
      underlying,
      valuationDate,
      fixings);
  }
   ...
   */
  public static OvernightIndexRatesImpliedForward.Builder builder() {
    return new OvernightIndexRatesImpliedForward.Builder();
  }

  private OvernightIndexRatesImpliedForward(
      OvernightIndexRates underlying,
      LocalDate valuationDate,
      LocalDateDoubleTimeSeries fixings) {
  ...
  @Override
  public OvernightIndexRatesImpliedForward.Meta metaBean() {
    return OvernightIndexRatesImpliedForward.Meta.INSTANCE;
  }
   ...
   */
  public OvernightIndexRates getUnderlying() {
    return underlying;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      OvernightIndexRatesImpliedForward other = (OvernightIndexRatesImpliedForward) obj;
  ...
  public static final class Meta extends DirectMetaBean {
     ...
     */
    private final MetaProperty<OvernightIndexRates> underlying = DirectMetaProperty.ofImmutable(
        this, "underlying", OvernightIndexRatesImpliedForward.class, OvernightIndexRates.class);
    /**
     * The meta-property for the {@code valuationDate} property.
     */
    private final MetaProperty<LocalDate> valuationDate = DirectMetaProperty.ofImmutable(
        this, "valuationDate", OvernightIndexRatesImpliedForward.class, LocalDate.class);
    /**
    ...
    private final MetaProperty<LocalDateDoubleTimeSeries> fixings = DirectMetaProperty.ofImmutable(
        this, "fixings", OvernightIndexRatesImpliedForward.class, LocalDateDoubleTimeSeries.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public OvernightIndexRatesImpliedForward.Builder builder() {
      return new OvernightIndexRatesImpliedForward.Builder();
    }

    @Override
    public Class<? extends OvernightIndexRatesImpliedForward> beanType() {
      return OvernightIndexRatesImpliedForward.class;
    }
     ...
     */
    public MetaProperty<OvernightIndexRates> underlying() {
      return underlying;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1770633379:  // underlying
          return ((OvernightIndexRatesImpliedForward) bean).getUnderlying();
        case 113107279:  // valuationDate
          return ((OvernightIndexRatesImpliedForward) bean).getValuationDate();
        case -843784602:  // fixings
          return ((OvernightIndexRatesImpliedForward) bean).getFixings();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code OvernightIndexRatesImpliedForward}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<OvernightIndexRatesImpliedForward> {

    private OvernightIndexRates underlying;
     ...
     */
    private Builder(OvernightIndexRatesImpliedForward beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case -1770633379:  // underlying
          this.underlying = (OvernightIndexRates) newValue;
          break;
        case 113107279:  // valuationDate
    ...
    @Override
    public OvernightIndexRatesImpliedForward build() {
      return new OvernightIndexRatesImpliedForward(
          underlying,
          valuationDate,
          fixings);
     ...
     */
    public Builder underlying(OvernightIndexRates underlying) {
      JodaBeanUtils.notNull(underlying, "underlying");
      this.underlying = underlying;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(128);
      buf.append("OvernightIndexRatesImpliedForward.Builder{");
      buf.append("underlying").append('=').append(JodaBeanUtils.toString(underlying)).append(',').append(' ');
      buf.append("valuationDate").append('=').append(JodaBeanUtils.toString(valuationDate)).append(',').append(' ');
      buf.append("fixings").append('=').append(JodaBeanUtils.toString(fixings));
      buf.append('}');
