...
import marc.henrard.murisq.product.swap.type.OvernightOvernightSwapTemplate;

/**
 * A node based on a Overnight-Overnight swap.
 * 
 * @author Marc Henrard
 */
@BeanDefinition
public final class OvernightOvernightSwapCurveNode
  ...
  private final OvernightOvernightSwapTemplate template;
  /**
  ...
  /**
   * Generate an instance of a overnight-overnight swap based node from a template and an ID.
   *
   ...
   */
  public static OvernightOvernightSwapCurveNode of(OvernightOvernightSwapTemplate template, ObservableId rateId) {
   ...
   * @return a node whose instrument is built from the template using a market rate
   */
  public static OvernightOvernightSwapCurveNode of(
      OvernightOvernightSwapTemplate template, 
      ObservableId rateId, 
  ...
  /**
   * Generate an instance of a overnight-overnight swap based node from a template, an ID, a spread and a label.
   *
   * @param template  the template defining the node instrument
   * @param rateId  the identifier of the market data providing the rate for the node instrument
   * @param additionalSpread  the additional spread amount added to the spread
  ...
  public static OvernightOvernightSwapCurveNode of(
    ...
    return new OvernightOvernightSwapCurveNode(
  ...
  // estimate the last fixing date as the end date
   ...
   */
  public OvernightOvernightSwapCurveNode withDate(CurveNodeDate date) {
    return new OvernightOvernightSwapCurveNode(template, rateId, additionalSpread, label, date, dateOrder);
  }
  

  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code OvernightOvernightSwapCurveNode}.
   * @return the meta-bean, not null
   */
  public static OvernightOvernightSwapCurveNode.Meta meta() {
    return OvernightOvernightSwapCurveNode.Meta.INSTANCE;
  }

  static {
    MetaBean.register(OvernightOvernightSwapCurveNode.Meta.INSTANCE);
  }
   ...
   */
  public static OvernightOvernightSwapCurveNode.Builder builder() {
    return new OvernightOvernightSwapCurveNode.Builder();
  }

  private OvernightOvernightSwapCurveNode(
      OvernightOvernightSwapTemplate template,
      ObservableId rateId,
      double additionalSpread,
      String label,
  ...
  @Override
  public OvernightOvernightSwapCurveNode.Meta metaBean() {
    return OvernightOvernightSwapCurveNode.Meta.INSTANCE;
  }
   ...
   */
  public OvernightOvernightSwapTemplate getTemplate() {
    return template;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      OvernightOvernightSwapCurveNode other = (OvernightOvernightSwapCurveNode) obj;
  ...
  public String toString() {
    ...
    buf.append("OvernightOvernightSwapCurveNode{");
  ...
  public static final class Meta extends DirectMetaBean {
     ...
     */
    private final MetaProperty<OvernightOvernightSwapTemplate> template = DirectMetaProperty.ofImmutable(
        this, "template", OvernightOvernightSwapCurveNode.class, OvernightOvernightSwapTemplate.class);
    /**
    ...
    private final MetaProperty<ObservableId> rateId = DirectMetaProperty.ofImmutable(
        this, "rateId", OvernightOvernightSwapCurveNode.class, ObservableId.class);
    /**
    ...
    private final MetaProperty<Double> additionalSpread = DirectMetaProperty.ofImmutable(
        this, "additionalSpread", OvernightOvernightSwapCurveNode.class, Double.TYPE);
    /**
     * The meta-property for the {@code label} property.
     */
    private final MetaProperty<String> label = DirectMetaProperty.ofImmutable(
        this, "label", OvernightOvernightSwapCurveNode.class, String.class);
    /**
     * The meta-property for the {@code date} property.
     */
    private final MetaProperty<CurveNodeDate> date = DirectMetaProperty.ofImmutable(
        this, "date", OvernightOvernightSwapCurveNode.class, CurveNodeDate.class);
    /**
    ...
    private final MetaProperty<CurveNodeDateOrder> dateOrder = DirectMetaProperty.ofImmutable(
        this, "dateOrder", OvernightOvernightSwapCurveNode.class, CurveNodeDateOrder.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public OvernightOvernightSwapCurveNode.Builder builder() {
      return new OvernightOvernightSwapCurveNode.Builder();
    }

    @Override
    public Class<? extends OvernightOvernightSwapCurveNode> beanType() {
      return OvernightOvernightSwapCurveNode.class;
    }
     ...
     */
    public MetaProperty<OvernightOvernightSwapTemplate> template() {
      return template;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case -1321546630:  // template
          return ((OvernightOvernightSwapCurveNode) bean).getTemplate();
        case -938107365:  // rateId
          return ((OvernightOvernightSwapCurveNode) bean).getRateId();
        case 291232890:  // additionalSpread
          return ((OvernightOvernightSwapCurveNode) bean).getAdditionalSpread();
        case 102727412:  // label
          return ((OvernightOvernightSwapCurveNode) bean).getLabel();
        case 3076014:  // date
          return ((OvernightOvernightSwapCurveNode) bean).getDate();
        case -263699392:  // dateOrder
          return ((OvernightOvernightSwapCurveNode) bean).getDateOrder();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code OvernightOvernightSwapCurveNode}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<OvernightOvernightSwapCurveNode> {

    private OvernightOvernightSwapTemplate template;
     ...
     */
    private Builder(OvernightOvernightSwapCurveNode beanToCopy) {
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        case -1321546630:  // template
          this.template = (OvernightOvernightSwapTemplate) newValue;
          break;
        case -938107365:  // rateId
    ...
    @Override
    public OvernightOvernightSwapCurveNode build() {
      preBuild(this);
      return new OvernightOvernightSwapCurveNode(
          template,
          rateId,
     ...
     */
    public Builder template(OvernightOvernightSwapTemplate template) {
      JodaBeanUtils.notNull(template, "template");
      this.template = template;
      return this;
    }
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(224);
      buf.append("OvernightOvernightSwapCurveNode.Builder{");
