 ...
 * <p>
 * Based on {@link CalibrationMeasures} but with split of sensitivities in the extractSensitivity method. 
 * Maybe this change should be incorporated in the original method.
 */
public final class CalibrationSplitMeasures {
   ...
   */
  public static final CalibrationSplitMeasures PAR_SPREAD = CalibrationSplitMeasures.of(
      "ParSpread",
   ...
   */
  public static final CalibrationSplitMeasures MARKET_QUOTE = CalibrationSplitMeasures.of(
      "MarketQuote",
   ...
   */
  public static final CalibrationSplitMeasures PRESENT_VALUE = CalibrationSplitMeasures.of(
      "PresentValue",
   ...
   */
  public static CalibrationSplitMeasures of(String name, List<? extends CalibrationMeasure<? extends ResolvedTrade>> measures) {
    return new CalibrationSplitMeasures(name, measures);
  }
   ...
   */
  @SafeVarargs
  public static CalibrationSplitMeasures of(String name, CalibrationMeasure<? extends ResolvedTrade>... measures) {
    return new CalibrationSplitMeasures(name, ImmutableList.copyOf(measures));
  }

  //-------------------------------------------------------------------------
  // restricted constructor
  private CalibrationSplitMeasures(String name, List<? extends CalibrationMeasure<? extends ResolvedTrade>> measures) {
  ...
  private UnitParameterSensitivities extractSensitivities(ResolvedTrade trade, RatesProvider provider) {
    ...
    for (CurrencyParameterSensitivity ccySens : paramSens.getSensitivities()) {
      unitSens = unitSens.combinedWith(UnitParameterSensitivities.of(ccySens.toUnitParameterSensitivity().split()));
    }
    return unitSens;
  }
