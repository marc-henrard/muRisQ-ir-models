...
public final class OvernightOvernightSwapTemplate
  ...
  /**
   * Create an instance of the template from a tenor and a convention.
   * <p>
   * The swap's start is spot.
   * 
  ...
  /**
   * Create an instance o the template from a (forward) start period, a tenor and a convention.
   * 
  ...
  /**
   * Creates a trade based on the template.
   * <p>
   * The trade is based on the specific trade date. The buy/sell flag refer to the spread payment on
   * the first leg: buy is paying the spread and sell is receiving the spread.
   * 
