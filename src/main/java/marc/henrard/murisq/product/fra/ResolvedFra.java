...
/**
 * This is a modified version of the original Strata ResolvedFra to deal with IBOR Fallback. 
...
public final class ResolvedFra
   ...
   * The set of indices.
   */
  private final transient ImmutableSet<RateIndex> indices;  // not a property, derived and cached from input data
  ...
  private static ImmutableSet<RateIndex> buildIndices(RateComputation floatingRate) {
    ImmutableSet.Builder<Index> builder = ImmutableSet.builder();
    floatingRate.collectIndices(builder);
    return builder.build().stream()
        .filter(index -> index instanceof RateIndex)
        .map(index -> RateIndex.class.cast(index))
  ...
  private Object readResolve() {
    return new ResolvedFra(
        currency, notional, paymentDate, startDate, endDate, yearFraction, fixedRate, floatingRate, spread, discounting);
  }
   ...
   */
  public Set<RateIndex> allIndices() {
    return indices;
  }
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<Double> spread = DirectMetaProperty.ofImmutable(
        this, "spread", ResolvedFra.class, Double.TYPE);
    /**
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case -895684237:  // spread
          return ((ResolvedFra) bean).getSpread();
        case -536441087:  // discounting
