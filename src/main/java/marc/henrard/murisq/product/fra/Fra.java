...
/**
 * This is a modified version of the original Strata Fra to deal with IBOR Fallback. 
 * It accept floating rate with rate computation different from IBOR and a spread added on the floating rate.
 */
/**
...
public final class Fra
  ...
  /**
   * For FRA with overnight index, the end of the overnight rate composition.
   */
  @PropertyDefinition(get = "optional")
  private final LocalDate endCompositionDate;
  /**
   ...
   * A 5% rate will be expressed as 0.05.
   * <p>
   * This defines the spread, which is used to add an amount to the observed rate.
   */
  @PropertyDefinition
  ...
  //-------------------------------------------------------------------------
  public static Fra of(com.opengamma.strata.product.fra.Fra fraStrata) {
    return new Fra(fraStrata.getBuySell(), 
        fraStrata.getCurrency(), 
        fraStrata.getNotional(), 
        fraStrata.getStartDate(), 
        fraStrata.getEndDate(), 
        null,
        fraStrata.getBusinessDayAdjustment().orElse(null), 
        fraStrata.getPaymentDate(), 
        fraStrata.getFixedRate(), 
        0.0d, 
        fraStrata.getIndex(), 
        fraStrata.getFixingDateOffset(), 
        fraStrata.getDayCount(), 
        fraStrata.getDiscounting());
  }
  ...
  private static void preBuild(Builder builder) {
    if (builder.index != null) {
      ...
      if (builder.fixingDateOffset == null) {
        if(builder.index instanceof IborIndex) {
          builder.fixingDateOffset = ((IborIndex) builder.index).getFixingDateOffset();
        } else {
          builder.fixingDateOffset = DaysAdjustment.NONE;
        }
      }
  ...
  private void validate() {
    ...
    if(index instanceof OvernightIndex) {
      ArgChecker.notNull(endCompositionDate, "endCompositionDate");
    }
  }
  ...
  // creates an Ibor or Overnight computation
  private RateComputation createRateComputation(ReferenceData refData) {
    ...
    if (index instanceof IborIndex) {
      return IborRateComputation.of((IborIndex) index, fixingDate, refData);
    } else {
      return OvernightRateComputation.of((OvernightIndex) index, fixingDate,
          endCompositionDate, 0, OvernightAccrualMethod.COMPOUNDED, refData);
    }
  }
  ...
  private Fra(
    ...
    this.endCompositionDate = endCompositionDate;
  ...
  //-----------------------------------------------------------------------
  /**
   * Gets for FRA with overnight index, the end of the overnight rate composition.
   * @return the optional value of the property, not null
   */
  public Optional<LocalDate> getEndCompositionDate() {
    return Optional.ofNullable(endCompositionDate);
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      ...
      return JodaBeanUtils.equal(buySell, other.buySell) &&
          ...
          JodaBeanUtils.equal(endCompositionDate, other.endCompositionDate) &&
  ...
  public int hashCode() {
    ...
    hash = hash * 31 + JodaBeanUtils.hashCode(endCompositionDate);
  ...
  public String toString() {
    ...
    buf.append("endCompositionDate").append('=').append(endCompositionDate).append(',').append(' ');
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    /**
     * The meta-property for the {@code endCompositionDate} property.
     */
    private final MetaProperty<LocalDate> endCompositionDate = DirectMetaProperty.ofImmutable(
        this, "endCompositionDate", Fra.class, LocalDate.class);
    /**
    ...
    protected MetaProperty<?> metaPropertyGet(String propertyName) {
      switch (propertyName.hashCode()) {
        ...
        case -1607727319:  // endDate
          return endDate;
        case 1458013725:  // endCompositionDate
          return endCompositionDate;
     ...
     * @return the meta-property, not null
     */
    public MetaProperty<LocalDate> endCompositionDate() {
      return endCompositionDate;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        ...
        case 1458013725:  // endCompositionDate
          return ((Fra) bean).endCompositionDate;
        case -1065319863:  // businessDayAdjustment
  ...
  public static final class Builder extends DirectFieldsBeanBuilder<Fra> {
    ...
    private LocalDate endCompositionDate;
    ...
    private Builder(Fra beanToCopy) {
      ...
      this.endCompositionDate = beanToCopy.endCompositionDate;
    ...
    public Builder set(String propertyName, Object newValue) {
      switch (propertyName.hashCode()) {
        ...
        case -1607727319:  // endDate
          ...
          break;
        case 1458013725:  // endCompositionDate
          this.endCompositionDate = (LocalDate) newValue;
          break;
        case -1065319863:  // businessDayAdjustment
    ...
    /**
     * Sets for FRA with overnight index, the end of the overnight rate composition.
     * @param endCompositionDate  the new value
     * @return this, for chaining, not null
     */
    public Builder endCompositionDate(LocalDate endCompositionDate) {
      this.endCompositionDate = endCompositionDate;
      return this;
    }
    ...
    public String toString() {
      ...
      buf.append("endCompositionDate").append('=').append(JodaBeanUtils.toString(endCompositionDate)).append(',').append(' ');
