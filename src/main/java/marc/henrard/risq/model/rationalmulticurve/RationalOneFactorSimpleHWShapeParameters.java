 ...
 */
@BeanDefinition
public final class RationalOneFactorSimpleHWShapeParameters
   ...
   * @return the instance
   */
  public static RationalOneFactorSimpleHWShapeParameters of(
      double a, 
      double b00, 
      double eta, 
      double kappa, 
    ...
    return new RationalOneFactorSimpleHWShapeParameters(
  ...
  private RationalOneFactorSimpleHWShapeParameters(
      double a, 
      double b00, 
      double eta, 
      double kappa, 
  ...
  @Override
  public RationalOneFactorSimpleHWShapeParameters withParameter(int parameterIndex, double newValue) {
    return new RationalOneFactorSimpleHWShapeParameters(
  ...
  //------------------------- AUTOGENERATED START -------------------------
  /**
   * The meta-bean for {@code RationalOneFactorSimpleHWShapeParameters}.
   * @return the meta-bean, not null
   */
  public static RationalOneFactorSimpleHWShapeParameters.Meta meta() {
    return RationalOneFactorSimpleHWShapeParameters.Meta.INSTANCE;
  }

  static {
    MetaBean.register(RationalOneFactorSimpleHWShapeParameters.Meta.INSTANCE);
  }
   ...
   */
  public static RationalOneFactorSimpleHWShapeParameters.Builder builder() {
    return new RationalOneFactorSimpleHWShapeParameters.Builder();
  }

  @Override
  public RationalOneFactorSimpleHWShapeParameters.Meta metaBean() {
    return RationalOneFactorSimpleHWShapeParameters.Meta.INSTANCE;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj != null && obj.getClass() == this.getClass()) {
      RationalOneFactorSimpleHWShapeParameters other = (RationalOneFactorSimpleHWShapeParameters) obj;
  ...
  public static final class Meta extends DirectMetaBean {
    ...
    private final MetaProperty<TimeMeasurement> timeMeasure = DirectMetaProperty.ofImmutable(
        this, "timeMeasure", RationalOneFactorSimpleHWShapeParameters.class, TimeMeasurement.class);
    /**
    ...
    private final MetaProperty<DiscountFactors> discountFactors = DirectMetaProperty.ofImmutable(
        this, "discountFactors", RationalOneFactorSimpleHWShapeParameters.class, DiscountFactors.class);
    /**
     * The meta-property for the {@code valuationTime} property.
     */
    private final MetaProperty<LocalTime> valuationTime = DirectMetaProperty.ofImmutable(
        this, "valuationTime", RationalOneFactorSimpleHWShapeParameters.class, LocalTime.class);
    /**
    ...
    private final MetaProperty<ZoneId> valuationZone = DirectMetaProperty.ofImmutable(
        this, "valuationZone", RationalOneFactorSimpleHWShapeParameters.class, ZoneId.class);
    /**
     * The meta-properties.
     */
    ...
    @Override
    public RationalOneFactorSimpleHWShapeParameters.Builder builder() {
      return new RationalOneFactorSimpleHWShapeParameters.Builder();
    }

    @Override
    public Class<? extends RationalOneFactorSimpleHWShapeParameters> beanType() {
      return RationalOneFactorSimpleHWShapeParameters.class;
    }
    ...
    protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
      switch (propertyName.hashCode()) {
        case 97:  // a
          return ((RationalOneFactorSimpleHWShapeParameters) bean).getA();
        case 95714:  // b00
          return ((RationalOneFactorSimpleHWShapeParameters) bean).getB00();
        case 100754:  // eta
          return ((RationalOneFactorSimpleHWShapeParameters) bean).getEta();
        case 101817675:  // kappa
          return ((RationalOneFactorSimpleHWShapeParameters) bean).getKappa();
        case 1642109393:  // timeMeasure
          return ((RationalOneFactorSimpleHWShapeParameters) bean).getTimeMeasure();
        case -91613053:  // discountFactors
          return ((RationalOneFactorSimpleHWShapeParameters) bean).getDiscountFactors();
        case 113591406:  // valuationTime
          return ((RationalOneFactorSimpleHWShapeParameters) bean).getValuationTime();
        case 113775949:  // valuationZone
          return ((RationalOneFactorSimpleHWShapeParameters) bean).getValuationZone();
      }
  ...
  //-----------------------------------------------------------------------
  /**
   * The bean-builder for {@code RationalOneFactorSimpleHWShapeParameters}.
   */
  public static final class Builder extends DirectFieldsBeanBuilder<RationalOneFactorSimpleHWShapeParameters> {
     ...
     */
    private Builder(RationalOneFactorSimpleHWShapeParameters beanToCopy) {
    ...
    @Override
    public RationalOneFactorSimpleHWShapeParameters build() {
      return new RationalOneFactorSimpleHWShapeParameters(
          a,
          b00,
          eta,
    ...
    public String toString() {
      StringBuilder buf = new StringBuilder(288);
      buf.append("RationalOneFactorSimpleHWShapeParameters.Builder{");
