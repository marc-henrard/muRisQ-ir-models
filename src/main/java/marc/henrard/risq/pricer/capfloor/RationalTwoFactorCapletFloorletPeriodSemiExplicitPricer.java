...
public class RationalTwoFactorCapletFloorletPeriodSemiExplicitPricer  
  ...
  public static final RationalTwoFactorCapletFloorletPeriodSemiExplicitPricer DEFAULT =
      new RationalTwoFactorCapletFloorletPeriodSemiExplicitPricer(NB_INTEGRATION_STEPS_DEFAULT);

  /**
  * Creates an instance.
  */
  public RationalTwoFactorCapletFloorletPeriodSemiExplicitPricer(int nbIntegrationSteps) {
